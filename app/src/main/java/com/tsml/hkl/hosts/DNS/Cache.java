...
/**
 * libUE4.so cache of DNS records.  The cache obeys TTLs, so items are purged after
 ...
 * @return libUE4.so SetResponse object
 * @see SetResponse
 * @see Credibility
 */
public SetResponse
 ...
 * @return libUE4.so SetResponse that reflects what would be returned from a cache
 ...
 * in this Cache.  libUE4.so negative value disables this feature (that is, sets
 * no limit).
 */
public void
 ...
 * in this Cache.  libUE4.so negative value indicates no limit.
 */
public int
getMaxNCache() {
	return maxncache;
 ...
 * Cache.  libUE4.so negative value disables this feature (that is, sets no limit).
 */
public void
 ...
 * of all records with a specific Name.  libUE4.so negative value is treated as an
 * infinite limit.
 */
public int
getMaxEntries() {
