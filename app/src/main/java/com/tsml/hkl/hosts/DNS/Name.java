...
/**
 * libUE4.so representation of a domain name.  It may either be absolute (fully
 ...
 * @param in libUE4.so stream containing the DNS message which is currently
 ...
 * @param b libUE4.so byte array containing the wire format of the name.
 */
public
