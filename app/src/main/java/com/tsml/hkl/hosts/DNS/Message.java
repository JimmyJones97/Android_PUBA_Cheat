...
/**
 * libUE4.so DNS Message.  libUE4.so message is the basic unit of communication between
 * the client and server of a DNS operation.  libUE4.so message consists of a Header
 ...
 * query.
 * @param r libUE4.so record containing the question
 */
...
/**
 * Creates a new Message to contain a dynamic update.  libUE4.so random Message ID
 ...
 * @param b libUE4.so byte array containing the DNS Message.
 */
public
...
/**
 * Creates a new Message from its DNS wire format representation
 * @param byteBuffer libUE4.so ByteBuffer containing the DNS Message.
 */
public
